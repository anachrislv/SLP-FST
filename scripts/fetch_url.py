...
if __name__ == "__main__":
    url = sys.argv[1] if len(sys.argv) > 1 else "https://raw.githubusercontent.com/hermitdave/FrequencyWords/master/content/2016/en/en_50k.txt"
    ...
    preprocessed = process_file(text, preprocess=preprocess)
